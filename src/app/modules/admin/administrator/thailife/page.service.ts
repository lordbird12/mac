...
export class Service {
    ...
    create(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/krongjai',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
    ...
    getClass(): Observable<any> {
        return this._httpClient.get(environment.API_URL + '/api/krongjai').pipe(
            switchMap((response: any) => {
                return of(response);
            })
        );
    ...
    getList(): Observable<any> {
        return this._httpClient
            .get<any>(environment.API_URL + 'api/get_krongjai')
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    getById(positionId: any): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + '/api/krongjai/' + positionId)
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    update(data: any): Observable<any> {
        return this._httpClient
            .post(
                environment.API_URL + '/api/update_krongjai',
                data,
                this.httpOptionsFormdata
            )
            .pipe(
