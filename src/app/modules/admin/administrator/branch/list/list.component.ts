...
export class ListComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.formData = this._formBuilder.group({
            ...
            line_link: ['', Validators.required],
            website: ['', Validators.required],
            marker_top: ['', Validators.required],
            marker_left: ['', Validators.required],
            image: '',
        });
    ...
    edit(id: string): void {
        this._Service.getById(id).subscribe((resp: any) => {
            ...
            this.formData.patchValue({
                ...
                work: this.itemData.work,
                map: this.itemData.map,
                call: this.itemData.call,
                email: this.itemData.email,
                facebook: this.itemData.facebook,
                facebook_link: this.itemData.facebook_link,
                line: this.itemData.line,
                line_link: this.itemData.line_link,
                website: this.itemData.website,
                marker_top: this.itemData.marker_top,
                marker_left: this.itemData.marker_left,
            });
        });
    }
