...
export class Service {
    ...
    getList(): Observable<any> {
        return this._httpClient
            .get<any>(environment.API_URL + 'api/get_interest')
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    delete(id: any): Observable<any> {
        return this._httpClient.delete<any>(
            environment.API_URL + '/api/interest/' + id,
            { headers: this.httpOptionsFormdata.headers }
        );
    }
    ...
    getById(id: any): Observable<any[]> {
        return this._httpClient
            .get<any[]>(environment.API_URL + '/api/interest/' + id)
            .pipe(
                tap((meterial) => {
                    this._materials.next(meterial);
                })
    ...
    getPage(dataTablesParameters: any): Observable<DataTablesResponse> {
        return this._httpClient.post(environment.API_URL + '/api/interest_page', dataTablesParameters, this.httpOptionsFormdata).pipe(
          switchMap((response: any) => {
